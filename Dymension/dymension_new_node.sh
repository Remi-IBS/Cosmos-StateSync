...
SEEDS="10ed1e176d874c8bb3c7c065685d2da6a4b86475@seed-dymension.ibs.team:16676"
...
sleep 2
  ...
  sed -E -i -s 's/minimum-gas-prices = \".*\"/minimum-gas-prices = \"5000000000adym\"/' $DAEMON_HOME/config/app.toml
